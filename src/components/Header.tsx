  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass-header border-b">
      <div className="max-w-[480px] mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <Link
          href="/profile"
          className="w-9 h-9 rounded-full flex items-center justify-center text-whiskey-muted hover:text-whiskey-gold transition-[color] duration-100 ease-out active:scale-90"
          style={{
